...
namespace EventHubTestReceiveEvent
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            string blobConnectionString = "DefaultEndpointsProtocol=https;AccountName=eventhubteststorage2;AccountKey=cacwGETegYX6t/I73k84o381ABPsqSGBYogHbsPyA9iAOxJomm8HckY9ysLOIR3WvdfXUrsWAL3++AStMPc7Ng==;EndpointSuffix=core.windows.net";
